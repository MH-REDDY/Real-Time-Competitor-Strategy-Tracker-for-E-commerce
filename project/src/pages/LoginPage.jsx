  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (activeTab === 'user' && isSignup) {
        ...
        // Call register with the correct parameters
        const result = await register({
          name: formData.name,
          email: formData.username, // email is the username in this case
          username: formData.username.split('@')[0], // Use part before @ as username
        ...
        if (result && result.success) {
          ...
          setError(result.error || 'Unable to login. Please check your username and password.');
        }
      }
    } catch (err) {
